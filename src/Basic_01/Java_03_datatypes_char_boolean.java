 ...
 * Unicode in a internatinal encoding standard for use with different languages and scripts, buy which each letter,digit or symol is assigned a unique 
 * numeric value that applies across different platforms and programms 
 * a-z -26 chars and there are total of 65535 characters 
 * 
 * */
