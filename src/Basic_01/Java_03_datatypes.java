...
/* Java 8 primitive types: byte,short,int,long,char.boolean ,float and double(building blocks of data manipulation )
  ...
  > A byte occupies 8 bits. A bit is not directly represented in Primitive type. 
  > short 16 bits, int 32 bits and long of 64 bits
  We should understand that different data types occupies different values .
 */		
	public static void main(String[] args) {
		...
		// int maxvalueforint= 2147483648; this will show an error in the ide when we remove the comment coz value is out of range 
		 value=21_47_483_647;
		System.out.println("value is accepted when given as 21_47_483_647  "+value);
//Java uses a concept of wrapper class for all 8 primitive types so here its Integer we can perform actions with primitives
...
// Casting 
		value =(value/2);
		// byte newbyteval=(byteminval/2); the error is coz java is considering the value between () as a int value 
		//Casting means to treat or convert a number from one type to another we do by : (byte)(byteminval/2)
