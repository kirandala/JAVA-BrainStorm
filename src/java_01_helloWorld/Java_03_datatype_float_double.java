...
public class Java_03_datatype_float_double {
	/*
	 * floating point number have decimeal points and we need to add floating point
	 * number incase we need precision precision refers to the format and amount of
	 * space occupied by the type. single precision(float) occupies 32 bits(So has
	 * width of 32) and double(double type) precision occupies 64 bits.
	 */
	public static void main(String[] args) {
		 ...
		 * but none are great to use where precise calculations are required this is ude
		 * to a limitation with how floating point number are stored and not a java
		 * problem
		 * 
