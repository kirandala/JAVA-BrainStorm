...
public class Java_05_ifthen_statements {
	 ...
	 * if tells program to execute a certain section of code only if particular test
	 * evaluates to true
	 */
	public static void main(String[] args) {
		...
		if (isbadboy != false) {
			...
			System.out.println("Enterd the code block 2 where == is used");
		}
		...
		// if we close the statement after the if statement it wont work coz we are
		// ending the command without java deciding to run the code block
		// If else statement should always be used with code block after if and else
		// keywords .having code block will help to easy to understand.
