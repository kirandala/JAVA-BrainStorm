...
public class Java_04_Operators {
	...
	/*
	 * Operators in java are special symbols that perform operations on on ot more
	 * operands and return a result. Operand is a term used to describe any object
	 * that is manipulated by an operator. "=" is assignment operator and is used to
	 * assign a value to left hand side variable.
	 */
	public static void main(String[] args) {
		...
		if (result <= 10) {
			...
			System.out.println(" code is out of if statement ");
		}
	}
